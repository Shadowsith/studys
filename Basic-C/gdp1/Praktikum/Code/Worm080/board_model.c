...
extern enum ResCodes initializeLevel(struct board* aboard){
    ...
    placeItem(aboard,  6,  9,BC_FOOD_1,SYMBOL_FOOD_1,COLP_FOOD_1);
    ...
    placeItem(aboard, 18, 60,BC_FOOD_2,SYMBOL_FOOD_2,COLP_FOOD_2);
    placeItem(aboard, 20,  5,BC_FOOD_3,SYMBOL_FOOD_3,COLP_FOOD_3);
    placeItem(aboard,  7, 14,BC_FOOD_3,SYMBOL_FOOD_3,COLP_FOOD_3);
    placeItem(aboard,  5, 55,BC_FOOD_3,SYMBOL_FOOD_3,COLP_FOOD_3);
