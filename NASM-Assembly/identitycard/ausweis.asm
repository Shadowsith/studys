...
mov eax,0
add ecx,4
cmp ecx,36          ; 9x läuft die Schleife (36 = 9*4)
jne casting

mov ecx,0           ; Counter ecx zurücksetzten

jmp ascii0to0       ; Nach Casting springt zur Umrechnung der Ascii-Zahlen, Z. 88
...
mov edx,0           ; Setzt edx (Modulo) auf 0
mov ecx,10          ; Modulo 10 
div ecx             ; eax/ecx

push edx            ; Divisionsrest ist erste/rechteste Stelle der Gesamtsumme
push msg            ; Entspricht der Prüfziffer des Personalausweises
call printf
add  esp,8
